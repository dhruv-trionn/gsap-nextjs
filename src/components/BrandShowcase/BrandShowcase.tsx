...
const DEFAULT_BRANDS: Brand[] = [
  {
    ...
    image: '/images/orbit/orbit-01.jpg',
    label: 'REAL ESTATE PLATFORM',
  },
  {
    name: 'Credible',
    image: '/work-kuros.jpg',
    label: 'LOAN COMPARISON',
  },
  {
    name: 'Yellowtail',
    image: '/images/orbit/orbit-02.jpg',
    label: 'WINE & SPIRITS',
  },
  {
    name: 'My Worker',
    image: '/work-luxury-presence.jpg',
    label: 'WORKFORCE MANAGEMENT',
  },
  {
    name: 'Re-events',
    image: '/images/orbit/orbit-03.jpg',
    label: 'EVENT PLATFORM',
  },
  {
    name: 'Ockto',
    image: '/work-willam-jonshan.jpg',
    label: 'DATA SERVICES',
  },
  {
    name: 'Improvi',
    image: '/images/orbit/orbit-04.jpg',
    label: 'HEALTH & WELLNESS',
  },
  {
    name: 'Technish',
    image: '/images/orbit/orbit-05.jpg',
