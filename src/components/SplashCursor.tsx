...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const BASE_HUE = Math.random(); // or hardcode: 0.6

    function generateColor(): ColorRGB {
      // const v = 0.6 + Math.random() * 0.4; // fade range
      // const c = HSVtoRGB(BASE_HUE, 1.0,v);

      // Always new color generates
      // const BASE_HUE =  Math.random(); // or hardcode: 0.6

      const c = HSVtoRGB(BASE_HUE, 1.0, 1.0);
      c.r *= 0.15;
      c.g *= 0.15;
      c.b *= 0.15;
      return c;
